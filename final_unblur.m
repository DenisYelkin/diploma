function [result] = final_unblur(blur_I, a)
    ...
    for i = 3 : length(blur_I(:,1)) - 2
        for j = 3 : length(blur_I(1,:)) - 2
            ...
            result(i, j) = round(b0 * a(1) + b1 * a(2) + b2 * a(3) + b2^2 * a(4) + b2^3 * a(5) + b3 * a(6) + b3^2 * a(7) + b3^3 * a(8) + b4 * a(9) + b4^2 * a(10) + b4^3 * a(11) + b5 * a(12) + b5^2 * a(13) + b5^3 * a(14) + b6 * a(15) + b6^2 * a(16) + b6^3 * a(17));
        end
    end
end